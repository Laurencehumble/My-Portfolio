    ...
    <section id="contact" className="py-16">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-12">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-bold font-patua_one mb-4 text-gray-900"
            data-aos="fade-up"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-[#4E635C] mb-2 font-patua_one">Phone</h3>
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-[#4E635C] mb-2 font-patua_one">Email</h3>
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-[#4E635C] mb-2 font-patua_one">Address</h3>
